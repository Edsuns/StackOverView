...
class StackViewTouchHandler<Model> implements SwipeHelper.Callback {
    ...
    StackViewTouchHandler(Context context, StackView<Model> sv,
                          StackViewConfiguration config, StackViewScroller scroller) {
